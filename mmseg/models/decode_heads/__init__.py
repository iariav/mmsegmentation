...
from .ham_multihead import LightHamMultiHead
...
from .segformer_multihead import SegformerMultiHead
...
__all__ = [
    ...
    'DDRHead', 'VPDDepthHead', 'SideAdapterCLIPHead','SegformerMultiHead','LightHamMultiHead'
]
