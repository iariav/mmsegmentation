...
class ProbotDataset(BaseSegDataset):
    #Our custom dataset.
    ...
    def __init__(self, **kwargs):
        super(ProbotDataset, self).__init__(
            img_suffix='.png',
            seg_map_suffix='.png',
            **kwargs)
    ...
    def load_data_list(self):
        ...
        if osp.isfile(self.ann_file):
            ...
            for line in lines:
                # IMAGE
                img_name = line.strip().replace('Labels', 'Images')
                data_info = dict(
                    img_path=img_name)
                # LABEL
                seg_map = line.strip()
                ...
                # # DEPTH
                # depth_name = line.strip().replace('Labels', 'Depth/npy')
...
@DATASETS.register_module()
class ProbotDepthDataset(BaseSegDataset):
    #Our custom dataset.
    ...
    def __init__(self,
        ...
        super(ProbotDepthDataset, self).__init__(
            img_suffix='.png',
            **kwargs)

    def _get_image_filename(self, depth_file):
        """Get the corresponding depth file from an image file."""
        image_file = depth_file.replace('ThermalDepth/npy','ThermalImages').replace('Depth/npy','Images').replace('depth','Day').replace('npy','png').replace('npz','png').replace('processed_','')
