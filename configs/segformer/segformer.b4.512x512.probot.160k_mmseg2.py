...
val_depth_evaluator = dict(type='DepthMetrics', min_depth=0.1, max_depth=65.0, depth_metrics=['RMSE'])
...
work_dir = '/home/iariav/Deep/Pytorch/mmsegmentation/work_dirs/b4_sgd_test_seg_mse'