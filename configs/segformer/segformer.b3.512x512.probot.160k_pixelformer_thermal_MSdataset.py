...
dataset_ms_depth_train = dict(
    type='RepeatDataset',
    times=1,
    dataset=dict(
        type='MSDepthDataset',
        data_root='/hdd_data/UrbanDepthData/MSdataset',
        ann_file='MS_trainval.txt',
        depth_scale=1,
        pipeline=train_ms_depth_pipeline,
        min_depth=1e-3,
        max_depth=65
    )
)
...
work_dir = '/home/iariav/Deep/Pytorch/mmsegmentation/work_dirs/b3_sgd_pixelformer_thermal_with_msdataset'