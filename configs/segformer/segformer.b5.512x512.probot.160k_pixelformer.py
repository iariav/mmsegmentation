...
train_cfg = dict(type='TwoDataloadersIterBasedTrainLoop', DepthDataloader=train_depth_dataloader, max_iters=420000, val_interval=4000
                 )
...
work_dir = '/home/iariav/Deep/Pytorch/mmsegmentation/work_dirs/b5_pixelformer'