...
model = dict(
    ...
    data_preprocessor = dict(
        ...
        seg_pad_val=255),
    backbone=dict(
        init_cfg=dict(type='Pretrained', checkpoint='pretrain/mit_b1_mmseg2.pth'),
        in_channels=1,
        embed_dims=64,
        num_layers=[2, 2, 2, 2],
        num_heads=[1, 2, 5, 8]),
...
work_dir = '/home/iariav/Deep/Pytorch/mmsegmentation/work_dirs/b1_sgd_pixelformer_thermal_win7_smoothness'